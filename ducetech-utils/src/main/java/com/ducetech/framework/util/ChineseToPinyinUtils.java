...
public class ChineseToPinyinUtils {
	 ...
	 * @param chinese 中文字符串
	 * @param mode    拼音模式枚举
	 * @return java.lang.String 遇到多音字会有多种结果,返回一种结果
	 * @throws
	 * @Title: toPinyinFirst
	 * @Date: 17-9-29 下午1:42
	 */
	 ...
	 * @param chinese 中文字符串
	 * @param mode    拼音模式枚举
	 * @return java.util.Set<java.lang.String> 遇到多音字会有多种结果
	 * @throws
	 * @Title: toPinyin
	 * @Date: 17-9-29 下午1:27
	 */
	 ...
	 * 判断输入char类型变量的字符类型
	 * @param c char类型变量
	 * @return ChineseToPinyinConvertor.CharType 字符类型枚举
	 * @throws
	 * @Title: checkType
	 * @Date: 17-9-29 下午1:33
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		for (String item : raws) {
			...
			pinyins.addAll(toPinyin(item, MODE.whole));
		}
